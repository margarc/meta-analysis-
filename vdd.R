...
#
# Prevalence of vdd in those studies using <= 50 nmol as threshold for vd levels in septic individuals
...
#
# Mortality risk in: case-control and cross sectional studies 
...
#
# Mortality risk studies from India
